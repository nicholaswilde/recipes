...
## Description
This skill leverages `lychee` in offline mode to identify broken local references (file paths, images, cross-references) across all recipes, and uses the dynamic link auto-fixer script to resolve them instantly.
