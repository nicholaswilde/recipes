...
onto a surface dusted with flour and shape into a flat disk.
...
!!! tip
    ...
    The cookie dough can be saved in the freezer for later.
...
!!! tip
    ...
    Dock the shortbread with a fork to preserve the short texture.
