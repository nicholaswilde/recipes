...
- :gear: Stand mixer with paddle attachment
- :spoon: Spatula
- :cookie: Baking sheet
- :page_facing_up: Parchment paper
- :package: Plastic wrap
- :cup_with_straw: 1/3-cup measure

## :pencil: Instructions

### Step 1

In a :gear: stand mixer fitted with the paddle attachment, cream the :butter: unsalted butter (225 g) and :candy: granulated sugar (300 g) together on medium-high for 2 to 3 minutes until pale and fluffy.

### Step 2

Scrape down the sides of the bowl. Add the :egg: egg and beat on medium-high for 7 to 8 minutes.

### Step 3

Reduce the mixer speed to low. Add the :bread: all-purpose flour (225 g) (or :bread: bread flour for a taller cookie), :chestnut: corn flour (45 g), :chestnut: freeze-dried corn powder (65 g), :chestnut: baking powder (3 g), :chestnut: baking soda (1.5 g), and :salt: kosher salt (6 g). Mix just until the dough comes together for no longer than 1 minute. Do not overmix.

### Step 4

Use a :cup_with_straw: 1/3-cup measure to portion the dough onto a parchment-lined :cookie: sheet pan. Pat the tops of the dough domes flat with your palm.

### Step 5

Wrap the :cookie: sheet pan tightly in :package: plastic wrap and refrigerate for at least 1 hour (up to 1 week). Do not bake from room temperature.
