...
* **Usage**: `python3 scripts/move_and_verify.py`
...
* **Usage**: `python3 scripts/zensical_fix.py`
...
* **Usage**: `python3 scripts/convert-recipe-units.py <recipe.md>`
...
* **Usage**: `python3 scripts/fix_broken_links.py`
...
* **Usage**: `python3 scripts/check-recipe-emojis.py <recipe.cook>`
...
* **Usage**: `python3 scripts/generate_typos_config.py`
...
* **Usage**: `python3 scripts/sync_giscus_comments.py`
